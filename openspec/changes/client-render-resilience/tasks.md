...
- [ ] 6.3 Commit Slice 2 to `main` as one commit (`renderWithAct.tsx` + 3 render suites). Independently revertable; test-only, cannot affect runtime. — Left for the parent to commit (apply-phase instruction: leave tree dirty).
