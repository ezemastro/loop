...
export default function Wish({
  ...
  return (
    <Pressable className="flex-grow bg-white p-4 border border-stroke rounded-xl" onPress={onEdit}>
      ...
      <CategoryBadge category={wish.category} className="text-lg text-main-text mr-14" />
